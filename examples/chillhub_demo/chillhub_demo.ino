...
void doorMessageCallback(unsigned char doorStatus) {
  ...
  // send a raw message to the ChillHub.  this one is directed at the cloud and sends content equal 
  // to the number of times that door events have been received
  ChillHub.sendU16Msg(0x50, doorCounts);
}

void alarmCallback(unsigned char currentTime[4]) {
